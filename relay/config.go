...
type Config struct {
	...
	TimescaleRelays []TimescaleConfig `toml:"timescale"`
}
...
type TimescaleConfig struct {
	// Name identifies the timescale relay
	Name string `toml:"name"`

	// Addr is where the Timescale Relay will listen for packets
	Addr string `toml:"bind-addr"`
	...
	CronSchedule string `toml:"cron-schedule"`
	// A list of graphite backend servers
	Outputs []TimescaleOutputConfig `toml:"output"`
}

type TimescaleOutputConfig struct {
